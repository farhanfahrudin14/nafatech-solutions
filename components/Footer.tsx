...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-[#f9fbfd] to-[#eaf2fb] text-gray-700 pt-16 pb-10 px-6 md:px-12 overflow-hidden">
      {/* Accent blue even softer */}
      <div
        className="absolute inset-0 bg-gradient-to-b 
  from-transparent via-blue-200/25 to-blue-500/30 pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        {/* Navigation */}
        <div>
          <h3 className="text-[#0A57F7] font-semibold mb-4">Navigasi</h3>
        ...
        {/* Services */}
        <div>
          <h3 className="text-[#0A57F7] font-semibold mb-4">Layanan Kami</h3>
